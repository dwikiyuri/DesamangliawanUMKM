...
<head>
    ...
    <title>Reset Password Admin Website Mangliawan</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-blue-900 mb-4">Reset Password</h1>
                                    </div>
                                    <?php
                                    ...
                                    <form class="user" method="POST" action>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                             id="inputPasswordKonfirmasi" placeholder="Konfirmasi Password" name="konfirmasi_password">
                                        </div>
