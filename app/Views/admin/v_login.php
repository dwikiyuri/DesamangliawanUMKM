...
<head>
    ...
    <title>Login Admin Website Mangliawan</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?><div class="alert alert-succes"><?php
                                    ...
                                    <form class="user" method="POST" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="inputUserName" name="username" value="<?php if ($session->getFlashdata('username')) echo $session->getFlashdata('username') ?>" placeholder="Username">
                                        </div>
                                        <div class="form-group">
