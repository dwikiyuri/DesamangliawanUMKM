...
<head>
    ...
    <title>Desa Mangliawan - Forgot Password</title>
                                    ...
                                    <form class="user" method="POST" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="inputEmail" name="username" value="<?php if ($session->getFlashdata('username')) echo $session->getFlashdata('username') ?>"
                                                placeholder="Enter Email or Username">
                                        </div>
                                        <input type="submit" name="submit" class="btn btn-primary btn-user btn-block" value="Kirim Email Recovery">
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo site_url("admin/login")  ?>">Already have an account? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
