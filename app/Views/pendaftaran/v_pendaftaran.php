    ...
    ?>
        <div class="row">
          <div class="col-12 col-md-10 mx-auto text-left">
            <form
            action="" method="POST" enctype="multipart/form-data" class="row"
            >
              <div
              ...
              <div class="col-12 py-3">
                ...
                <input
                  type="text"
                  class="form-control <?=($validate->hasError('nama_toko')) ? 'is-invalid': ''; ?>"
              ...
              <div class="col-md-6 py-3">
                ...
                <input
                  type="text"
                  class="form-control <?=($validate->hasError('nama_pemilik')) ? 'is-invalid': ''; ?> fh5co_contact_text_box"
                  placeholder="Nama Usaha UMKM"
              ...
              <div class="col-md-6 py-3">
                ...
                <input
                  type="text"
                  class="form-control <?=($validate->hasError('alamat')) ? 'is-invalid': ''; ?> fh5co_contact_text_box"
              ...
              <div class="col-md-6 py-3">
                <label class="tkpd" for="input_link_tokopedia">Tokopedia</label>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">
                      <svg
